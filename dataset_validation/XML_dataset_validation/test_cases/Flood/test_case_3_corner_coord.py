DESCRIPTION = """
Test Case: Corner Coordinate Validation for Flood
...
Inputs:
   ...
   * Latitude           : [-90.0000 .. 90.0000], series of 5 values, The first and last values must be equal
   * Longitude          : [-180.0000 .. 180.0000], series of 5 values, The first and last values must be equal
   * SARData_Sample     : [0 .. 50000], series of 5 values, The first and last values must be equal
   * SARData_Line       : [0 .. 20000], series of 5 values, The first and last values must be equal
   * Scene_Sample       : [0 .. 2000], series of 5 values, The first,forth and fith numbers must be equal, The second and third must be equal
   * Scene_Line         : [0 .. 2000], series of 5 values, The first,second and fith numbers must be equal, The forth and third must be equal
...
RANGES = {
    'ProcessingData/Corner_Coord/Latitude': (5, -90.0000, 90.0000),             #range:[-90.0000 .. 90.0000], series of 5 values, The first and last values must be equal
    'ProcessingData/Corner_Coord/Longitude': (5, -180.0000, 180.0000),          #range:[-180.0000 .. 180.0000], series of 5 values, The first and last values must be equal
    'ProcessingData/Corner_Coord/SARData_Sample': (5, 0, 50000),                #range:[0 .. 50000], series of 5 values, The first and last values must be equal
    'ProcessingData/Corner_Coord/SARData_Line': (5, 0, 20000),                  #range:[0 .. 20000], series of 5 values, The first and last values must be equal
    'ProcessingData/Corner_Coord/Scene_Sample': (5, 0, 2000),                   #range:[0 .. 2000], series of 5 values, The first,forth and fith numbers must be equal, The second and third must be equal
    'ProcessingData/Corner_Coord/Scene_Line': (5, 0, 2000),                     #range:[0 .. 2000], series of 5 values, The first,second and fith numbers must be equal, The forth and third must be equal
}
...
def validate_latitude(text, errors, count, min_val, max_val):
    ...
    if floats[0] != floats[4] :
        errors.append("Scene_Line: The first and last values must be equal")
...
def validate_scene_sample(text, errors, count, min_val, max_val):
    ...
    if ints[0] != ints[3] or ints[0] != ints[4] or ints[1] != ints[2]:
        errors.append("Scene_Sample: first,forth and fith numbers must be equal, second and third must be equal")
...
def validate_scene_line(text, errors, count, min_val, max_val):
    ...
    if ints[0] != ints[1] or ints[0] != ints[4] or ints[2] != ints[3]:
        errors.append("Scene_Line: first,second and fith numbers must be equal, forth and third must be equal")
