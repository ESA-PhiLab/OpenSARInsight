DESCRIPTION = """
Test Case: Corner Coordinate Validation for Dark Vessel Detection
...
Inputs:
   ...
   * Scene_Sample       : [0 .. 2000], series of 4 values, The first and last values must be equal, The middle two values must be equal
   * Scene_Line         : [0 .. 2000], series of 4 values, The first two values must be equal, The last two values must be equal
...
RANGES = {
    ...
    'ProcessingData/Corner_Coord/Scene_Sample': (4, 0, 2000),                   #range:[0 .. 2000], series of 4 values, The first and last values must be equal, The middle two values must be equal
    'ProcessingData/Corner_Coord/Scene_Line': (4, 0, 2000),                     #range:[0 .. 2000], series of 4 values, The first two values must be equal, The last two values must be equal
}
