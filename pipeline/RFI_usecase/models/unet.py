...
Description: UNet for Range-Compressed SAR RFI segmentation.

Key properties
--------------
- Input:  4 channel range-compressed input.
- Output: raw logits; apply loss/activation outside.
...
History:
    - 2025-12-08:
        First version of UNet was added.
    - 2025-12-20:
        Final version of UNet was added, with detailed comments.
...
class UNet(nn.Module):
    ...
    Args:
        in_channels:   Number of input channels (use 4 for RC I/Q).
    ...
    def _ensure_4d(x: torch.Tensor) -> None:
        """
        Validate that the input tensor follows the expected NCHW layout.
        Args:
            x: Input tensor expected to have shape (N, C, H, W).
        Raises:
