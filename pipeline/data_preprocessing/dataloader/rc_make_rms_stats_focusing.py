...
def make_loader_for_calibration(
    ...
    ds = RCDataset(
        data_dir=train_dir,
        use_masks=False, # CHANGE: no masks for rms stats
...
def main() -> None:
    ...
    # Adjusted for focusing model RMS stats
    args.train_dir = None 
    args.batch_size = 16
    args.num_workers = 3
    args.strict_missing_masks = False
    args.no_valid_mask = True
