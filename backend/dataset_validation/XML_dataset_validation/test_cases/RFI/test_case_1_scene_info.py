...
Inputs:
   ...
   * Scene_ID   : [DB_OPENSAR_RFI_0001 .. DB_OPENSAR_RFI_9999]
...
RANGES = {
    'Scene_Info/Scene_ID': (r'^DB_OPENSAR_RFI_(\d{1,4})$', 1, 9999),    #range:[DB_OPENSAR_RFI_0001 .. DB_OPENSAR_RFI_9999]
    'Scene_Info/Date': (20000101, 20251231),                            #range:[20000101 .. 20251231]
    'Scene_Info/Version': (0, None),                                    #range:[0 .. infinite]
    'Scene_Info/CaseStudy': 'RFIDetection',                             #range:[RFIDetection]
}
